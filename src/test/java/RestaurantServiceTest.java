...
class RestaurantServiceTest {
	...
	// <<<<<<<<<<<<<<<<<<<<USER: SELECTING ITEMS COST
	// ESTIMATION>>>>>>>>>>>>>>>>>>>>>>>>>>

	@Test
	public void cost_estimation_of_selected_items() throws restaurantNotFoundException {
		List<Item> selectedItems = new ArrayList<>();
		selectedItems.add(new Item("Sweet corn soup", 119));
		selectedItems.add(new Item("Vegetable lasagne", 269));

		assertEquals(388, service.getTotalCost(selectedItems));
	}
